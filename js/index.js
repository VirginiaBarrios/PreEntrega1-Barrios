...
for (let i = 0; i <= 3; i++) {
    switch(i) {
        ...
        case 2:
            ...
            break;
        case 3:
            pregunta = "Con respecto a la exposición al sol, ¿es mejor dejar la planta al sol directo durante pocas horas o 2. con abundante luz solar indirecta? (Elegir entre 1 y 2)";
            respuestaCorrecta = "2";
